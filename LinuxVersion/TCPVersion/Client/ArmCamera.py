...
cap = cv2.VideoCapture(int(cnf[0]), cv2.CAP_V4L2)
cap2 = cv2.VideoCapture(int(cnf[1]), cv2.CAP_V4L2)
...
def show_frame():
    ...
    img_flip1 = rotate_90
    img_flip_1 = rotate_90_counter
    numpy_horizontal_concat = np.concatenate((img_flip_1, img_flip1), axis=1)
